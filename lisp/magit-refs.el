               ...
               (let ((branch (cdr (magit-split-branch-name ref))))
                 (if (magit-branch-p branch)
                     (if (magit-rev-eq branch ref)
                         (magit-call-git "stashonto" branch)
...
Branch %s already exists.
  ...
  [a]bort " 'face 'minibuffer-prompt) branch branch branch ref branch)
                         ...
                         (?c (magit-call-git "stashonto" branch))
                         (?r (magit-call-git "stashonto" "-B" branch ref))
                         (?a (user-error "Abort"))))
                   (magit-call-git "stashonto" "-b" branch ref))
